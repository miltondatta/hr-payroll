...
<div class="modal" id="logisticmodel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content ">
            ...
            <form method="post" action="<?php echo base_url(); ?>projects/Add_Logistic" id="logisModalform">
                <div class="modal-body">
                    <div class="form-group row">
                        <label class="control-label col-md-3">Project List</label>
                        <select class="form-control col-md-8" data-placeholder="Choose a Category"
                    ...
                    <div class="form-group row">
                        ...
                        <select class="form-control taskclass col-md-3"
                                data-placeholder="Choose a Category" tabindex="1" name="taskid" id="taskval" required>
                        ...
                        <select class="select2 form-control col-md-4" data-placeholder="Choose a Category"
                                style="width:25%" tabindex="1" name="teamhead">
                            <option value="">Select Here</option>
                    ...
                    <div class="form-group row">
                        ...
                        <input type="text" name="startdate" class="form-control col-md-3"
                               id="calendar-month-six" data-format="yyyy-mm-dd">
                        <label class="control-label col-md-2">End Date</label>
                        <input type="text" name="enddate" class="form-control col-md-3"
                               id="calendar-month-seven" data-format="yyyy-mm-dd">
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <select class="select2 form-control col-md-4 assetsstock"
                                data-placeholder="Choose a Category" style="width:35%" tabindex="1" name="logistic">
                            <option value="">Select Here</option>
                        ...
                        <input type="number" name="qty" id="qty" class="form-control col-md-3"
                               placeholder="Qty" max="">
                        <div style="color:red; padding-right: 30px;" class="qty_error pt-1 ml-auto"></div>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="submit" <?php if ($this->session->userdata('user_type') == 'EMPLOYEE') { ?> disabled <?php } ?>
                            class="btn btn-primary rounded-btn">Submit
                    </button>
                </div>
            </form>
        </div>
...
<!-- sample modal content -->
<div class="modal" id="tasksmodel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content ">
            <div class="modal-header">
            ...
            <form method="post" action="<?php echo base_url() ?>projects/Add_Tasks" id="tasksModalform">
                <div class="modal-body">
                    <div class="form-group row">
                        <label class="control-label col-md-3">Project List</label>
                        <select class="form-control col-md-8 proid" data-placeholder="Choose a Category"
                    ...
                    <div class="form-group row">
                        ...
                        <input type="text" name="tasktitle" class="form-control col-md-8" id="recipient-name1"
                               minlength="8" maxlength="250" placeholder="Task Title...">
                    </div>
                    <div class="form-group row">
                        <label class="control-label col-md-3">Start Date</label>
                        <input type="text" name="startdate" class="form-control col-md-3"
                               id="calendar-month-three" data-format="yyyy-mm-dd">
                        <label class="control-label col-md-2">End Date</label>
                        <input type="text" name="enddate" class="form-control col-md-3 mydatepicker"
                               id="calendar-month-four" data-format="yyyy-mm-dd">
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <input name="type" type="radio" id="radio_4" data-value="Office" value="Office"
...
<!-- sample modal content -->
<div class="modal" id="fieldmodel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content ">
            <div class="modal-header">
            ...
            <form method="post" action="Add_Field_Tasks" id="tasksModalform" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="form-group row">
                        <label class="control-label col-md-3">Project List</label>
                        <select class="form-control col-md-6 proid" data-placeholder="Choose a Category"
                                tabindex="1" name="projectid">
                            <option value="<?php echo $details->id; ?>"><?php echo $details->pro_name; ?></option>
                        </select>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <select class="select2 form-control select2-multiple col-md-3"
                                data-placeholder="Choose a Category" multiple="multiple" style="width:25%" tabindex="1"
                                name="assignto[]">
                            <option value="">Select Here</option>
                            <?php foreach ($employee as $value): ?>
                                <option value="<?php echo $value->em_id; ?>"><?php echo $value->first_name; ?></option>
