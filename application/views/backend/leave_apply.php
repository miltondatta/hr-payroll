...
<?php $this->load->view('backend/sidebar'); ?>
    ...
    <main>
            ...
            <div class="row ">
                <div class="col-12  align-self-center">
                    <div class="sub-header mt-3 py-3 px-3 align-self-center d-sm-flex w-100 rounded">
                        <div class="w-sm-100 mr-auto"><h4 class="mb-0">Leave Application</h4></div>
                                    ...
                                    <div class="col-12">
                                        <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a
                                                    ...
                                                    class="text-white"><i class=""
                                                                          aria-hidden="true"></i>
                                                Add Application </a></button>
                                        <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a
                                                    href="<?php echo base_url(); ?>leave/Holidays" class="text-white"><i
                                                        class=""
                                                        aria-hidden="true"></i>
                                                Holiday List</a></button>
                                    </div>
                                <?php } ?>
                            </div>
                        </div>
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h4 class="card-title"><i class="fa fa-compass" aria-hidden="true"></i> Application List
                            </h4>
                        </div>
                        <div class="card-body">
                                        ...
                                        <?php } else{ ?>
                                            <td class="jsgrid-align-center">
                                                ...
                                                <?php } else if($value->leave_status == 'Not Approve'){ ?>
                                                    <a href="" title="Edit"
                                                       class="btn btn-sm btn-info waves-effect waves-light leaveapproval"
                                                       data-id="<?php echo $value->id; ?>">Approved</a>
                                                    <a href="" title="Edit"
                                                       class="btn btn-sm btn-info waves-effect waves-light  Status"
                                                       data-id="<?php echo $value->id; ?>"
                                                       data-value="Rejected">Reject</a>
                                                    <br>
                                                <?php } else if($value->leave_status == 'Rejected'){ ?>
                                                <?php } ?>
                                                <a href="" title="Edit"
                                                   class="btn btn-sm btn-info waves-effect waves-light leaveapp"
        ...
        <div class="modal" id="appmodel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
