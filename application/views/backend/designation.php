            ...
            <div class="row ">
                <div class="col-12  align-self-center">
                    <div class="sub-header mt-3 py-3 px-3 align-self-center d-sm-flex w-100 rounded">
                        <div class="w-sm-100 mr-auto"><h4 class="mb-0">Designation</h4></div>
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <form method="post"
                                                  action="<?php echo base_url(); ?>organization/update_des/<?php echo $editdesignation->id; ?>">
                                                <div class="form-group">
                                                    <label for="designation">Designation Name</label>
                                                    <input type="text" class="form-control" name="designation"
                                                           id="designation"
                                                           value="<?php echo $editdesignation->des_name; ?>"
                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <form method="post" action="Save_des">
                                                <div class="form-group">
                                                    <label for="designation">Designation Name</label>
                                                    <input type="text" class="form-control" name="designation"
                                                           id="designation"
                                                ...
                                                <div class="form-group">
                                                    <button class="btn btn-primary rounded-btn mb-2"><i
                                                                class="fa fa-check"></i> Save
                                                    </button>
                                                    <button class="btn btn-warning rounded-btn mb-2"><i
